...
const Data := preload('inventory_item_commandant_keys_state.gd')

var state: Data = load('res://game/inventory_items/commandant_keys/inventory_item_commandant_keys.tres')
