...
func _on_click() -> void:
	...
	# something:
	if Globals.CommandantKey:
		await C.player.walk_to_clicked()
		await C.player.face_clicked()
		E.goto_room('Palisade')
	else:
		await C.player.say("If only I had the key to this door, I could get to the palisade gate")
...
func _on_right_click() -> void:
	...
	# something:
	await C.player.face_clicked()
	await C.player.say("That door leads to the palisade outside")
